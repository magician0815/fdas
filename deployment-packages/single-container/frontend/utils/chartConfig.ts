...
export const chartThemes = {
  ...
  light: {
    ...
    ma30Color: '#ec4899',     // MA30 - 粉色
    ma60Color: '#06b6d4',     // MA60 - 青色
    ma120Color: '#84cc16',    // MA120 - 绿色
    ma240Color: '#f97316',    // MA240 - 橙红色
    // MACD配色
  ...
  return {
    ...
    dataZoom: [
      // 内置缩放（鼠标滚轮）
      {
        ...
        zoomOnMouseWheel: true,      // 保留滚轮缩放
        moveOnMouseMove: false,      // 禁用鼠标拖拽移动图表，让框选事件能正常工作
        moveOnMouseWheel: false,     // 禁用滚轮移动，只保留缩放
        // 缩放边界设置：最多显示300根，最少显示60根
        minValueSpan: 60,  // 最小显示60根K线
        maxValueSpan: 300, // 最大显示300根K线
        rangeMode: ['value', 'value'],  // 使用数值模式（固定K线数量）
        orient: 'horizontal'
      },
      // 滑块缩放
      {
