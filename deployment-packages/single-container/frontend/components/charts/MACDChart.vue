<template>
  <div class="macd-chart-container">
    <!-- 标题栏 -->
    <div class="chart-header" v-show="!minimized">
    ...
    dataZoom: [
      {
        type: 'inside',
        xAxisIndex: 0,
        start: 0,    // 初始值与主图一致，由echarts.connect同步
        end: 100,
        zoomOnMouseWheel: false,     // 副图不响应滚轮，由主图控制
        moveOnMouseMove: false,      // 副图不响应鼠标拖拽，由主图控制
