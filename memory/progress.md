...
| 数据源 | 记录数 | 频率 | 时间范围 |
|--------|--------|------|----------|
| core_pce (核心PCE) | 809 | 月度 | 1959-2026 |
| real_gdp (实际GDP) | 317 | 季度 | 1947-2026 |
| potential_gdp (潜在GDP) | 352 | 季度 | 1949-2036 |
| r-star-LW | 261 | 季度 | 1961-2026 |
| r-star-HLW | 261 | 季度 | 1961-2026 |
| r-star-LM | 237 | 季度 | 1967-2026 |
| r-sep | 21 | 按会议 | 2021-2026 |
| longer-run-neutral | 133 | 半年度 | 1960-2026 |
| **总计** | **2,391** | | |

### 第二批新增文件
- `macro_fred_csv.py` — FRED CSV 通用采集器 (core_pce/real_gdp/potential_gdp 共用)
- 种子数据新增 3 条, COLLECTOR_CLASS_MAP 扩展
- 前端指标下拉新增 3 项, Dashboard 自适应 8 卡
