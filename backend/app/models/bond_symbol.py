...
from sqlalchemy import Column, String, Boolean, DateTime, Date, Text, ForeignKey, Numeric, UniqueConstraint
...
class BondSymbol(Base):
    ...
    code = Column(String(20), nullable=False, index=True, comment="债券代码")
    ...
    __table_args__ = (
        UniqueConstraint("code", "market_id", name="uq_bond_symbols_code_market"),
    )