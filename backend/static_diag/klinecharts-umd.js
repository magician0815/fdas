...
function logTag() {
    log('%c❤️ Welcome to klinecharts. Version is 10.0.0', 'border-radius:4px;border:dashed 1px #1677FF;line-height:70px;padding:0 20px;margin:16px 0;font-size:14px;color:#1677FF;', '', '', '', '');
}
...
var StoreImp = /** @class */ (function () {
    ...
    StoreImp.prototype.setBarSpace = function (barSpace, adjustBeforeFunc) {
        if (barSpace < this._layoutOptions.barSpaceLimit.min ||
...
var YAxisImp = /** @class */ (function (_super) {
    ...
    YAxisImp.prototype._getIndicatorsByYAxisIds = function () {
        ...
        return parent.getChart().getChartStore().getIndicatorsByPaneId(parent.getId()).filter(function (indicator) { return ids.has(indicator.yAxisId); });
    };
