...
| **可扩展** | 预留扩展接口 | 插件式模块设计 |
| **市场统一** | 多市场共用一套K线方案 | MarketProfile声明式差异化配置 (V1.0.0) |
...
| | KLineChart | 10.0+ | 金融K线图Canvas渲染引擎，零依赖，MIT许可 |
| | ECharts | 5.5+ | Dashboard统计图表，辅助可视化 |
| | Pinia | 2.1+ | Vue3状态管理 |
| | Axios | 1.6+ | HTTP客户端 |
| | Vite | 5.0+ | 快速构建工具 |
